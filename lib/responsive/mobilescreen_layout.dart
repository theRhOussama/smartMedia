...
class _MobileScreenLayoutState extends State<MobileScreenLayout> {
 ...
 void onPageChanged(int page){
  setState(() {
    _page=page;
    print('${_page} is the current Page MotherFucker ----------------------------------');
  });
 }
  ...
  Widget build(BuildContext context) {
        ...
        return   Scaffold(
          appBar: AppBar(backgroundColor: secondColor,title:Text('سمارت ميديا'), centerTitle: false,
bottomOpacity: 0.0,
elevation: 0.0,),
          body:PageView(
              physics: NeverScrollableScrollPhysics(),controller: pageController,
            children: const [
