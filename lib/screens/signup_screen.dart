...
class _SignUpScreenState extends State<SignUpScreen> {
  ...
  final TextEditingController _firstnameInputController =
      TextEditingController();
  final TextEditingController _lastnameInputController =
      TextEditingController();
        ...
        Step(
          ...
          content: Center(
            child: Column(children: [
              ...
              Center(
                child: TextFieldInput.radio(UserTypeEnum.reader, _userTypeEnum,
                    Center(child: Text('ساستعمل التطبيق  : قارئ')), (val) {
                  setState(() {
                    _userTypeEnum = val;
              ...
              TextFieldInput.radio(UserTypeEnum.journalist, _userTypeEnum,
                  Center(child: Text('ساستعمل التطبيق : صحفي')), (val) {
                setState(() {
                  _userTypeEnum = val;
                  print('----------You are :  ${_userTypeEnum.toString()}');
                });
...
//--------------Confirm Password
        ...
        Step(
            ...
            content: const SizedBox(
                ...
                child: Center(
                  child: Text(
                    'المرجو الضغط على انشاء حساب ، مرحبا بكم في سمارت ميديا',
